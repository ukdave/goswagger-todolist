...
type FindHandlerFunc func(FindParams) middleware.Responder

// Handle executing the request and returning a response
func (fn FindHandlerFunc) Handle(params FindParams) middleware.Responder {
	return fn(params)
}

// FindHandler interface for that can handle valid find params
type FindHandler interface {
	Handle(FindParams) middleware.Responder
}
...
/*Find swagger:route GET / items find
